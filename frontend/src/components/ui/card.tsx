...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "flex flex-col gap-4 overflow-hidden rounded-xl border border-transparent bg-card py-4 text-sm text-card-foreground shadow-[0_2px_10px_rgba(0,0,0,0.35)]",
        className,
      )}
      {...props}
    />
...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return <div data-slot="card-title" className={cn("text-base font-medium leading-snug text-foreground", className)} {...props} />
}
