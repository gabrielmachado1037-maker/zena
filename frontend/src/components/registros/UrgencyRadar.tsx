import { ALERTAS_RADAR, type AlertaRadar } from "../../lib/registros";
...
// "Radar de Urgência" — alertas com dot pulsante + botão send.
export default function UrgencyRadar() {
  return (
        ...
        {ALERTAS_RADAR.map((a) => {
          ...
          return (
            ...
            >
              ...
              <button
                onClick={() => console.log(`[Registros] nudge → ${a.nome}`)}
