...
// `cor` = cor de identidade da liga, alinhada à arte 3D dos emblemas
// (bronze / prata / ouro / diamante azul / mestre VERMELHO / lendário ROXO).
...
// Mesma paleta usada no DashboardPreview. Mestre = vermelho, Lendário = roxo.
