      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="bg-white rounded-2xl p-8 space-y-8 text-zena-text-mid leading-relaxed">
          <Section titulo="1. Aceitação">
            Ao criar uma conta na Zena, você concorda integralmente com estes Termos de Uso e com nossa{" "}
          ...
          <Section titulo="2. Descrição do serviço">
            A Zena é uma plataforma de gestão para nutricionistas autônomos que inclui: cadastro de pacientes,
          ...
          <Section titulo="3. Cadastro e conta">
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>A Zena pode suspender contas que violem estes termos.</li>
            </ul>
          </Section>
          ...
          <Section titulo="4. Planos e pagamentos">
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li><strong>Plano Mensal:</strong> R$ 97/mês, cobrado mensalmente via Stripe.</li>
              <li><strong>Plano Anual:</strong> R$ 924/ano (equivalente a R$ 77/mês), cobrado anualmente.</li>
          ...
          <Section titulo="5. Cancelamento">
            ...
            para <a href="mailto:suporte@zena.app" className="text-zena-green-mid underline">suporte@zena.app</a>.
          ...
          <Section titulo="6. Responsabilidade pelo conteúdo">
            ...
            informações inseridas na plataforma. A Zena não é prestadora de serviços de saúde e não valida
          ...
          <Section titulo="7. Dados das pacientes">
            ...
            e o sigilo profissional exigido pelo CFN. A Zena atua como operadora dos dados (art. 39 da LGPD),
            sendo o nutricionista o controlador.
          </Section>

          <Section titulo="8. Propriedade intelectual">
            Todo o código, design, marca e conteúdo da Zena são de propriedade da Zena. Você recebe uma licença
          ...
          <Section titulo="9. Limitação de responsabilidade">
            A Zena não se responsabiliza por danos indiretos, lucros cessantes ou perda de dados decorrentes
          ...
          <Section titulo="10. Disponibilidade">
            A Zena não garante disponibilidade ininterrupta. Faremos manutenções programadas com aviso prévio
          ...
          <Section titulo="13. Contato">
            <a href="mailto:suporte@zena.app" className="text-zena-green-mid underline">suporte@zena.app</a>
          </Section>
        </div>
      </div>
    </div>
