    ...
    return (
      <div className="min-h-screen bg-nx-bg flex items-center justify-center px-4">
        <div className="text-center">
          <p className="text-nx-on-surface-variant">Link inválido.</p>
          <Link to="/esqueci-senha" className="text-nx-evo font-medium mt-2 block">Solicitar novo link</Link>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-nx-bg flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-nx-surface rounded-2xl shadow-sm border border-nx-border p-8">
          <h2 className="text-xl font-bold text-nx-on-surface mb-1">Criar nova senha</h2>
          <p className="text-nx-on-surface-variant text-sm mb-6">Escolha uma senha segura com pelo menos 6 caracteres.</p>
          {erro && (
            <div className="bg-nx-danger/10 border border-nx-danger/30 text-nx-danger rounded-xl p-3 text-sm mb-4">{erro}</div>
          )}
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-nx-on-surface mb-1">Nova senha</label>
              <input
                type="password"
                required
                value={novaSenha}
            ...
            <div>
              <label className="block text-sm font-medium text-nx-on-surface mb-1">Confirmar senha</label>
              <input
                type="password"
                required
                value={confirmar}
